...
class SuperResModelv2(UNet):
    ...
    def __init__(self, in_channels, resolution, model_channels, *args, **kwargs):
        super().__init__(in_channels * 2, resolution, model_channels, *args, **kwargs)
