...
#                         dataset.ddpm.evaluation.save_path=\'/data1/kushagrap20/ddpm_cifar10_uncond_repro_try1/2000_50k/\' \
...
python main/eval/ddpm/sample_cond.py +dataset=cifar10/test \
                        ...
                        dataset.ddpm.evaluation.device=\'gpu:0\' \
                        dataset.ddpm.evaluation.save_mode='image' \
                        dataset.ddpm.evaluation.chkpt_path=\'/data1/kushagrap20/diffusevae_cifar10_reprotry1_form1_largermodel/ddpmrepro-cifar10_reprotry1_form1_largermodel-epoch=2080-loss=0.0201.ckpt\' \
                        ...
                        dataset.ddpm.evaluation.temp=1.0 \
                        dataset.ddpm.evaluation.batch_size=64 \
                        dataset.ddpm.evaluation.save_path=\'/data1/kushagrap20/ddpm_cifar10_form1_larger_repro_try1/2080_expde_50k/\' \
                        dataset.ddpm.evaluation.z_cond=False \
                        dataset.ddpm.evaluation.n_samples=12500 \
                        dataset.ddpm.evaluation.n_steps=1000 \
                        dataset.ddpm.evaluation.save_vae=True \
